...
var Resizable = new Class({
	...
	set: function(distance, fromDrag){
		this.first.setStyle(this.firstProperty, distance + this.handleSize);
		this.second.setStyle(this.secondProperty, distance + (this.handleSize * 2));
		if(!fromDrag) this.element.setStyle(this.secondProperty, distance + this.handleSize);
		this.fireEvent('set');
		return this;
	},
